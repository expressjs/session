...
#### Options
  ...
  - `signature` - pass in your own cookie signing object here that implements the sign(value, secret) and unsign(value, secret) functions (default: `node-cookie-signature` module)
